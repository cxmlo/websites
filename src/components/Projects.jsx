...
const PROJECTS = [
  {
    id: 1,
    title: 'Landing App Servicios',
    cat: 'landing',
    tech: ['React', 'TypeScript'],
    desc: 'Landing de alta conversión para ventas de servicios. Formulario con validación, animaciones CSS y Google Ads integrado.',
    result: '+243 ventas / primer mes',
    imageUrl: '/img/1.jpg',
    liveUrl: 'https://diplomas-rho.vercel.app',
    accentColor: '#b9a6e9',
    mockupType: 'landing',
  },
  {
